...
function CortexHome() {
  ...
  const ProjectDetailsAnimationClassNames = {
  ...
  return (
    <div id="root-contained">
      ...
      <div id="center-panels-container">
        <CSSTransition in={state.portfolioPresentation === 'grid' ? true : false} appear={false} enter={true} timeout={1000} classNames={ProjectDetailsAnimationClassNames}>
          <section className="panel">
            ...
            <div id="grid">
              ...
              <HoverDescAnchor href="https://job.seldoncortex.com" target="_blank" src="./assets/home/MERNT_ChinguV42G21.png">
        ...
        <CSSTransition in={state.portfolioPresentation === 'grid' ? false : true} appear={false} enter={true} timeout={1000} classNames={ProjectDetailsAnimationClassNames}>
          <section className='panel portfolio-presentation-detailed'>
            <ProjectDetails
              portfolioPresentation={state.portfolioPresentation}
              onButtonClick={() => setState(oldState => {
